...
* @extend eve.Agent
*/
export function FusekiAgent(id, app) {
...
FusekiAgent.prototype = Object.create(eve.Agent.prototype);
FusekiAgent.prototype.constructor = FusekiAgent;

/**
* Send a greeting to an agent
* @param {String} to
*/
FusekiAgent.prototype.sayHello = function(to) {
  this.send(to, 'Hello ' + to + '!');
};

/**
* Handle incoming greetings. This overloads the default receive,
* so we can't use FusekiAgent.on(pattern, listener) anymore
* @param {String} from     Id of the sender
* @param {*} message       Received message, a JSON object (often a string)
*/
FusekiAgent.prototype.receive = function(from, message) {
